...
const options: swaggerJSDoc.Options = {
  definition: {
    ...
    info: {
      title: 'ELEVATE API',
      version: '1.0.0',
      description: 'Complete API documentation for ELEVATE learning platform with login/register authentication, file uploads, real-time notifications, search, and admin features',
      contact: {
        name: 'ELEVATE Team',
    ...
    tags: [
      { name: 'Auth', description: 'Login/Register authentication with OTP verification' },
